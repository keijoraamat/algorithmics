...
//         a[j + 1] = b;
    ...
    * Binary search.
    *
    * @param a The array where from searching is being made
    * @param start The start position of search
    * @param end The end position of search
    * @param key The value what is searched for
    *
